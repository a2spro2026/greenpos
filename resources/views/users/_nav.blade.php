@php
    $items = [
        ['route' => 'users.dashboard', 'label' => 'Dashboard', 'match' => 'users.dashboard'],
        ['route' => 'users.index', 'label' => 'Utilisateurs', 'match' => 'users.index'],
        ['route' => 'users.create', 'label' => 'Nouvel utilisateur', 'match' => 'users.create'],
    ];
@endphp
