@php
    $items = [
        ['route' => 'sales.dashboard', 'label' => 'Dashboard', 'match' => 'sales.dashboard'],
        ['route' => 'sales.index', 'label' => 'Ventes', 'match' => 'sales.index'],
        ['route' => 'sales.create', 'label' => 'Nouvelle vente', 'match' => 'sales.create'],
    ];
@endphp
