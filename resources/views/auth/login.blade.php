            ...
            @else
                <form method="POST" action="{{ route('login.attempt') }}">
                    ...
                    <div class="gp-auth-field">
                        ...
                        <div class="gp-auth-input-wrap">
                            ...
                            <input
                                ...
                                type="text"
                                name="email"
                                value="{{ old('email', app()->environment('local', 'testing') ? \App\Services\PlatformBootstrapService::SUPER_ADMIN_USERNAME : '') }}"
                                required
                                autofocus
                    ...
                    <div class="gp-auth-field">
                        ...
                        <div class="gp-auth-input-wrap">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            <input id="password" class="gp-auth-input" type="password" name="password" required autocomplete="current-password" placeholder="0661755048" @if(app()->environment('local', 'testing')) value="{{ \App\Services\PlatformBootstrapService::SUPER_ADMIN_PASSWORD }}" @endif>
                        </div>
                    </div>
                    <label class="gp-auth-remember">
                        <input type="checkbox" name="remember" value="1">
                ...
                @if(app()->environment('local', 'testing'))
                    <p class="gp-auth-demo">Démo : {{ \App\Services\PlatformBootstrapService::SUPER_ADMIN_USERNAME }} / {{ \App\Services\PlatformBootstrapService::SUPER_ADMIN_PASSWORD }}</p>
                @endif
